  ...
  const menus: Menu[] = [
    { path: "/", title: "मुख्य साइट" },
    {
      ...
      subMenu: [
        ...
        { path: "/vbh.rase/EditorialBoard", title: "संपादकीय बोर्ड" },
        { path: "/", title: "पीयर रिव्यू प्रक्रिया" },
        { path: "", title: "प्रकाशन नैतिकता" },
        { path: "/vbh.rase/Indexing", title: "एबस्ट्रैक्टिंग और इंडेक्सिंग" },
    ...
    },
    {
      ...
      subMenu: [
        ...
        { path: "/vbh.rase/SubmitManuscript", title: "मैन्यूस्क्रिप्ट जमा करें" },
        { path: "/vbh.rase/ManuscriptDetails", title: "पिछला मैन्यूस्क्रिप्ट " }
      ],
    },
    {
      path: "/",
    ...
    // },
    {
      path: "/vbh.rase/ReadArticlePage",
      title: "लेख पढ़ें",
    },
    { path: "/vbh.rase/table", title: "सामग्री की तालिका" },
    {
      path: "/",
      title: "विशेष मुद्दे",
      subMenu: [
