        ...
        <div className="container mx-auto px-4">
          <header className="relative flex items-center py-4 border-b pt-10 mb-8">
            ...
            <div className="flex-1 ml-28">
              <div className="text-2xl font-bold text-orange-600">Viksit Bharat Education Journal</div>
              <p className="text-sm text-gray-600 mt-1">Department of Holistic Education — DHE Publications</p>
            </div>
              ...
              <div className="relative">
                <div className="flex justify-end items-center space-x-4 md:space-x-0">
                  <ul className={`md:flex md:space-x-4 items-center ${isMenuOpen ? 'flex flex-col bg-orange-600 text-white p-4 space-y-4 absolute top-16 left-0 w-full z-10' : 'hidden'}`}>
                    <li>
                      <a href="/bal-shodh-patrika" className="text-black hover:underline hover:text-orange-600 transition duration-300 cursor-pointer">Bal Shodh Patrika</a>
                    </li>
                    <li>
                      <a href="/conferences" className="text-black hover:underline hover:text-orange-600 transition duration-300 cursor-pointer">Conferences</a>
                    </li>
                    <li>
                      <a href="/search" className="text-black hover:underline hover:text-orange-600 transition duration-300 cursor-pointer">Search</a>
                    </li>
                    <li>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-6">
              <div className="flex-1 min-w-[200px]">
                ...
                >
                  ...
                  <option value="/vbe">Viksit Bharat Education Journal (English)</option>
                  <option value="/vbh">Viksit Bharat Education Journal (Hindi)</option>
                  <option value="/vie">Viksit Bharat Journal English (Archive)</option>
                  <option value="/vih">Viksit Bharat Journal Hindi (Archive)</option>
                </select>
