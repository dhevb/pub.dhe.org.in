...
import AuthorDetails from "../../component/vbh_Component/AuthorDetails";
import ManuscriptAttachment from "../../component/vbh_Component/ManuscriptAttachment";
import ArticleDetails from "../../component/vbh_Component/ArticleDetails";
import ProgressBar from "../../component/vbh_Component/ProgressBar";
    ...
    <div className="relative bg-gray-100 min-h-screen">
      ...
      <div className="text-center mt-6">
        <h1 className="text-3xl font-bold">
          Manuscript Submission For Viksit Bharat Hindi
        </h1>
      </div>
