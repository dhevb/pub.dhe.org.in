...
import AuthorDetails from "../../component/vie_Component/AuthorDetails";
import ManuscriptAttachment from "../../component/vie_Component/ManuscriptAttachment";
import ArticleDetails from "../../component/vie_Component/ArticleDetails";
import ProgressBar from "../../component/vie_Component/ProgressBar";
    ...
    <div className="relative bg-gray-100 min-h-screen">
      ...
      <div className="text-center mt-6">
        <h1 className="text-3xl font-bold">
          Manuscript Submission For Viksit India English
        </h1>
      </div>
