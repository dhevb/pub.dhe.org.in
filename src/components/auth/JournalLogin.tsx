...
/**
 * Shared journal login — sets httpOnly cookies via /api/auth/login
 * and persists legacy localStorage for manuscript wizard compatibility.
 */
export function JournalLogin({
  onLogin,
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      <div className="relative w-full sm:max-w-md p-6 sm:p-8 bg-surface rounded-xl border border-border shadow-lg">
        <Link
          href="/"
          className="text-white text-xl px-4 py-2 bg-primary rounded-lg absolute left-0 top-0"
        >
          ×
        </Link>
